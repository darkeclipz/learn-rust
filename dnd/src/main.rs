...
use crate::entity::{Die, Entity, Weapon};
...
fn rpg_test() {
    ...
    let d8 = Die { eyes: 8 };
    let w1 = Weapon {
        name: String::from("Homunculus greatsword"),
        die: d8.clone(),
        value: 1_000_000,
    };
    let w2: Weapon = Weapon {
        name: String::from("Orc club"),
        die: d8.clone(),
        value: 100,
    };
    ...
    if max_turns < 0 {
        println!("Maximum number of turns has been exceeded.");
        return;
    }
